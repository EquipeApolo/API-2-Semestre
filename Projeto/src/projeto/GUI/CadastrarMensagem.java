...
public class CadastrarMensagem extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if  (!((jTextField1.getText().isEmpty()) || (jTextField4.getText().isEmpty()) || (jTextField2.getText().isEmpty()) || (jTextField5.getText().isEmpty()))){
            
                    
               Main.getManager().cadastrarMensagem(new Mensagem(jTextField1.getText(), jTextField4.getText(), jTextField2.getText(), jTextField5.getText(), System.currentTimeMillis() ));
