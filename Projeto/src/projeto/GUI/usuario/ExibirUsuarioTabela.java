...
public class ExibirUsuarioTabela extends javax.swing.JFrame {
    
    private Usuario usuario;
    private FuncaoUsuario funcaoUsuario;
    private TelaUsuariosCadastrados paginaUsuario;
    
    public ExibirUsuarioTabela(TelaUsuariosCadastrados paginaUsuario, Usuario usuario, FuncaoUsuario funcaoUsuario) {
        initComponents();
        ...
        //campoTipoPerfil.setText(funcaoUsuario.getFuncaoByName());
        
        
        //campoTipoPerfil.setName(usuario.getFuncaoUsuario());
        
//        Usuario funcao = Main.getManager().getUsuarioByID(usuario.getFuncaoUsuario());
//        campoTipoPerfil.setName(funcao.getFuncaoUsuario());
//
...
//        }
        ...
        funcaoUsuario.getFuncaoByName(comboBox);
